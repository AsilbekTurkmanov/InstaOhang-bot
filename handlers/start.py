...
from utils.helpers import get_main_reply_keyboard, check_user_subscriptions, get_subscription_keyboard
...
async def cmd_start(message: Message):
    ...
    if not is_subbed:
        await message.answer(
            ...
            f"🤖 Botdan foydalanish uchun iltimos quyidagi kanallarga obuna bo'ling:",
    ...
    await message.answer(welcome_text, reply_markup=get_main_reply_keyboard(is_admin), parse_mode="HTML")
...
async def cmd_about(message: Message):
    about_text = (
        "🤖 <b>InstaOhang Bot</b>\n\n"
        "✨ Instagram-dan yuqori sifatli video, reels va musiqalarni yuklovchi hamda videolarni Telegram Dumaloq formatiga (/round) o'tkazuvchi professional bot.\n\n"
        "🤖 Bot: @InstaOhang_bot\n"
